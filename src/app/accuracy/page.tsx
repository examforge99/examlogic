    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-[10px]">
        ...
        <select
          ...
          className="appearance-none bg-[#112236] border border-[#1a3a5c] rounded-[12px] px-6 py-1 pr-8 text-[11px] font-semibold text-[#a8c8e8] focus:outline-none cursor-pointer"
          style={{

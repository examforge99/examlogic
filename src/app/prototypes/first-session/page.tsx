...
const styles: Record<string, CSSProperties> = {
  ...
  modalBorder: { width: 'min(100%, 430px)', padding: '1px', borderRadius: '22px', background: 'conic-gradient(from var(--border-angle), rgba(63,183,255,0.22) 0%, rgba(63,183,255,0.22) 72%, rgba(63,183,255,0.62) 78%, rgba(47,128,255,0.34) 81%, rgba(37,214,162,0.18) 86%, rgba(63,183,255,0.22) 92%, rgba(63,183,255,0.22) 100%)', boxShadow: '0 24px 70px rgba(0,0,0,0.58), 0 8px 28px rgba(0,0,0,0.34), 0 0 22px rgba(47,128,255,0.06)', animation: 'borderOrbit 20s linear infinite', ['--border-angle' as string]: '0deg' },

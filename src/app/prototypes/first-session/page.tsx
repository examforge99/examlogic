...
const styles: Record<string, CSSProperties> = {
  ...
  modalBorder: { width: 'min(100%, 430px)', padding: '1px', borderRadius: '22px', background: 'conic-gradient(from var(--border-angle), #3FB7FF, #2F80FF 28%, #102C50 48%, #25D6A2 72%, #2F80FF 88%, #3FB7FF)', boxShadow: '0 30px 80px rgba(0,0,0,0.48), 0 0 32px rgba(63,183,255,0.07)', animation: 'borderOrbit 16s linear infinite', ['--border-angle' as string]: '0deg' },

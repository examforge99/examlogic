...
const styles: Record<string, CSSProperties> = {
  page: { minHeight: '100vh', background: '#071426', color: '#C9D1D9', fontFamily: 'var(--font-inter), system-ui, sans-serif', overflow: 'hidden', position: 'relative' },
  ...
  modalBorder: { width: 'min(100%, 430px)', padding: '1px', borderRadius: '22px', background: 'conic-gradient(from var(--border-angle), rgba(63,183,255,0.38) 0%, rgba(63,183,255,0.38) 68%, rgba(63,183,255,0.86) 76%, rgba(47,128,255,0.55) 81%, rgba(37,214,162,0.32) 86%, rgba(63,183,255,0.38) 94%, rgba(63,183,255,0.38) 100%)', boxShadow: '0 24px 70px rgba(0,0,0,0.58), 0 8px 28px rgba(0,0,0,0.34), 0 0 22px rgba(47,128,255,0.06)', animation: 'borderOrbit 20s linear infinite', ['--border-angle' as string]: '0deg' },
  ...
  description: { color: '#8D99A6', fontSize: '14px', lineHeight: 1.5, maxWidth: '350px', marginBottom: '24px' },
  ...
  infoLabel: { color: '#7F8A96', fontSize: '11px', marginBottom: '4px' },
  infoValue: { fontSize: '14px', fontWeight: 600, color: '#C9D1D9' },
  button: { width: '100%', minHeight: '52px', border: '1px solid rgba(255,255,255,0.16)', borderRadius: '13px', background: 'linear-gradient(180deg, #438FEF 0%, #2F80FF 48%, #286FDE 100%)', color: '#F2F4F6', fontFamily: 'var(--font-inter), system-ui, sans-serif', fontSize: '14px', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.18), 0 6px 18px rgba(47,128,255,0.18)' },
